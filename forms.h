...
//Notifier form: simply displays a weight
class Qt_widget_base_tab;
class Notifier : public QDialog
{
  Q_OBJECT
public:
  Notifier( float weight, QTabWidget * bar = 0 , QWidget* parent = 0 ,
...
//Weights Form; used for requesting weight of different faces
class Qt_widget_base_tab;
class WeightsForm : public QDialog
{
  Q_OBJECT
public:
  WeightsForm( QTabWidget * bar = 0 , QWidget* parent = 0 ,
                  int number_of_tabs = 0 , Qt_widget_base_tab *w_demo_p = 0,
                                  double scale = 0 , bool colors_flag = true);
  ~WeightsForm() {}
