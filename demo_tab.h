...
public:
  ...
  CGAL::Object locate(const Point_2& pt)
  {
    ...
    {
    	CGAL::Object obj1 = walk_pl->locate(pt);
		Face_const_handle f1 = get_face(obj1);
		printf("This face belongs to %s and has weight %f and initial area %f. \n",f1->getCountry(),f1->getWeight(),f1->getInitialArea());
...
public:
  ...
  void fill_face(Qt_widget_demo_tab<Conic_tab_traits> * w , Face_handle f)
  {
    ...
    {
      std::list< Coord_point > pts; // holds the points of the polygon
      /* running  around the outer of the face and generate from it
       * the polygon
       */
      Ccb_halfedge_circulator cc=f->outer_ccb();
      do {
