//File: Constructor for Windows (menus , butttons etc), Destructor and Main (Execution)
...
#include "icons/carto_new.xpm"
#include "icons/carto_start.xpm"
#include "icons/carto_weights.xpm"
#include "icons/carto_nextIt.xpm"
...
{
  const QString my_title_string("Circular Cartograms");
