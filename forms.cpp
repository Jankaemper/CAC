...
/*! constructor - build the weights dialog form */
Notifier::Notifier(float weight, QTabWidget * bar, QWidget* parent,
                               int /* number_of_tabs */,
  ...
  myBar(bar)
{
  ...
  textLabel1 = new QLabel( "The weight of the highligted face is: " + str, this );
...
/*! constructor - build the weights dialog form */
WeightsForm::WeightsForm(QTabWidget * bar, QWidget* parent,
                               int /* number_of_tabs */,
                               Qt_widget_base_tab * w_demo_p, double scale,
                               bool colors_flag):
  QDialog(parent),
  myBar(bar)
{
  setCaption( "Set Weights" );
  resize(180, 120 );

  optionsFormLayout = new QVBoxLayout( this, 11, 6 );

  arrLayout1 = new QHBoxLayout( 0, 0, 6 );
  textLabel1 = new QLabel( "Set Weight", this );
  arrLayout1->addWidget( textLabel1 );
  box1 = new QSpinBox( 0, 1000, 1, this, "Weights" );
  box1->setValue(100);
